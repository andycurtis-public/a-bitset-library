...
COPY --chown=dev:dev . /workspace/a-bitset-library
RUN mkdir -p /workspace/build/a-bitset-library && \
    cd /workspace/build/a-bitset-library && \
    cmake /workspace/a-bitset-library && \
